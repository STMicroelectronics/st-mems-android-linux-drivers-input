...
#define LSM9DS0_GYR_PM_OPS		(&lsm9ds0_gyr_pm_ops)
#else /* CONFIG_PM_SLEEP */
#define LSM9DS0_GYR_PM_OPS		NULL
...
static void lsm9ds0_gyr_spi_remove(struct spi_device *spi)
{
	struct lsm9ds0_gyr_dev *dev = spi_get_drvdata(spi);
...
#else
static int lsm9ds0_gyr_spi_remove(struct spi_device *spi)
{
	struct lsm9ds0_gyr_dev *dev = spi_get_drvdata(spi);
